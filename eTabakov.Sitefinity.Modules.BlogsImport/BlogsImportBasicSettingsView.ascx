...
<h2>
    <asp:Literal runat="server" ID="lUserAuthenticationAndSSO" Text="<%$Resources:BlogsImportResources, BasicSettingsHeader %>" />
</h2>
<div class="sfSettingsSection">
    <sfFields:TextField ID="sampleTextSelect" runat="server" DisplayMode="Write" DataFieldName="Text" Title="<%$Resources:BlogsImportResources, SampleTextTitle %>" />
</div>
...
<sfFields:FieldControlsBinder ID="fieldsBinder" runat="server" TargetId="fieldsBinder" 
    DataKeyNames="Id" ServiceUrl="~/eTabakovSitefinityModulesBlogsImport/eTabakov.Sitefinity.Modules.BlogsImport.BlogsImportBasicSettingsService.svc/config/"/>